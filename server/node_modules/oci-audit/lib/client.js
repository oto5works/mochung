...
class AuditClient {
     ...
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/audit/GetConfiguration.ts.html |here} to see how to use GetConfiguration API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/audit/ListEvents.ts.html |here} to see how to use ListEvents API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/audit/UpdateConfiguration.ts.html |here} to see how to use UpdateConfiguration API.
     */
