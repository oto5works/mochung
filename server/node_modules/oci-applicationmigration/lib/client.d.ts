...
export declare enum ApplicationMigrationApiKeys {
}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export declare class ApplicationMigrationClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): ApplicationMigrationWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
     */
    getWaiters(): ApplicationMigrationWaiter;
    /**
  ...
  *
     ...
     */
    changeSourceCompartment(changeSourceCompartmentRequest: requests.ChangeSourceCompartmentRequest): Promise<responses.ChangeSourceCompartmentResponse>;
    /**
  ...
  *
       ...
       */
    createSource(createSourceRequest: requests.CreateSourceRequest): Promise<responses.CreateSourceResponse>;
    /**
  ...
  *
     ...
     */
    listAllMigrations(request: requests.ListMigrationsRequest): AsyncIterableIterator<model.MigrationSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllMigrationsResponses(request: requests.ListMigrationsRequest): AsyncIterableIterator<responses.ListMigrationsResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.MigrationSummary objects
     * contained in responses from the listMigrations operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listMigrationsRecordIterator(request: requests.ListMigrationsRequest): AsyncIterableIterator<model.MigrationSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listMigrations operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listMigrationsResponseIterator(request: requests.ListMigrationsRequest): AsyncIterableIterator<responses.ListMigrationsResponse>;
    /**
     ...
     */
    listSourceApplications(listSourceApplicationsRequest: requests.ListSourceApplicationsRequest): Promise<responses.ListSourceApplicationsResponse>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllSourceApplications(request: requests.ListSourceApplicationsRequest): AsyncIterableIterator<model.SourceApplicationSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllSourceApplicationsResponses(request: requests.ListSourceApplicationsRequest): AsyncIterableIterator<responses.ListSourceApplicationsResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.SourceApplicationSummary objects
     * contained in responses from the listSourceApplications operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listSourceApplicationsRecordIterator(request: requests.ListSourceApplicationsRequest): AsyncIterableIterator<model.SourceApplicationSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listSourceApplications operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listSourceApplicationsResponseIterator(request: requests.ListSourceApplicationsRequest): AsyncIterableIterator<responses.ListSourceApplicationsResponse>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllSources(request: requests.ListSourcesRequest): AsyncIterableIterator<model.SourceSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllSourcesResponses(request: requests.ListSourcesRequest): AsyncIterableIterator<responses.ListSourcesResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.SourceSummary objects
     * contained in responses from the listSources operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listSourcesRecordIterator(request: requests.ListSourcesRequest): AsyncIterableIterator<model.SourceSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listSources operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listSourcesResponseIterator(request: requests.ListSourcesRequest): AsyncIterableIterator<responses.ListSourcesResponse>;
    /**
  ...
  *
       ...
       */
    migrateApplication(migrateApplicationRequest: requests.MigrateApplicationRequest): Promise<responses.MigrateApplicationResponse>;
    /**
  ...
  *
     ...
     */
    updateSource(updateSourceRequest: requests.UpdateSourceRequest): Promise<responses.UpdateSourceResponse>;
}
