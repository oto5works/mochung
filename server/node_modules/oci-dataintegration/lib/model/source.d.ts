...
export interface Source extends model.Operator {
    "entity"?: model.DataEntityFromTable | model.DataEntityFromDataStore | model.DataEntityFromView | model.DataEntityFromSql | model.DataEntityFromFile | model.DerivedEntity;
    /**
