...
export declare namespace DetectAnomaliesDetails {
    function getJsonObj(obj: DetectAnomaliesDetails): object;
    function getDeserializedJsonObj(obj: DetectAnomaliesDetails): object;
}
