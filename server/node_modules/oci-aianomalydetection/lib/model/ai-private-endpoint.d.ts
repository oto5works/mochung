...
export declare namespace AiPrivateEndpoint {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: AiPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: AiPrivateEndpoint): object;
}
