...
export declare namespace CreateAiPrivateEndpointDetails {
    function getJsonObj(obj: CreateAiPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: CreateAiPrivateEndpointDetails): object;
}
