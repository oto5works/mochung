...
export declare namespace InlineInputDetails {
    function getJsonObj(obj: InlineInputDetails, isParentJsonObj?: boolean): object;
    const inputType = "INLINE";
    function getDeserializedJsonObj(obj: InlineInputDetails, isParentJsonObj?: boolean): object;
}
