...
export declare namespace EmbeddedInputDetails {
    enum ContentType {
        Csv = "CSV",
        Json = "JSON"
    }
    function getJsonObj(obj: EmbeddedInputDetails, isParentJsonObj?: boolean): object;
    const inputType = "BASE64_ENCODED";
    function getDeserializedJsonObj(obj: EmbeddedInputDetails, isParentJsonObj?: boolean): object;
}
