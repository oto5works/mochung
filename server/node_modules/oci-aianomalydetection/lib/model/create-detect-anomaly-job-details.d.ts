...
export interface CreateDetectAnomalyJobDetails {
    ...
    "inputDetails": model.EmbeddedInputDetails | model.ObjectListInputDetails | model.InlineInputDetails;
    "outputDetails": model.ObjectStoreOutputDetails;
}
export declare namespace CreateDetectAnomalyJobDetails {
    function getJsonObj(obj: CreateDetectAnomalyJobDetails): object;
    function getDeserializedJsonObj(obj: CreateDetectAnomalyJobDetails): object;
}
