...
export declare namespace InlineDetectAnomaliesRequest {
    function getJsonObj(obj: InlineDetectAnomaliesRequest, isParentJsonObj?: boolean): object;
    const requestType = "INLINE";
    function getDeserializedJsonObj(obj: InlineDetectAnomaliesRequest, isParentJsonObj?: boolean): object;
}
