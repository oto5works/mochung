...
export declare namespace DataSourceDetailsInflux {
    function getJsonObj(obj: DataSourceDetailsInflux, isParentJsonObj?: boolean): object;
    const dataSourceType = "INFLUX";
    function getDeserializedJsonObj(obj: DataSourceDetailsInflux, isParentJsonObj?: boolean): object;
}
