...
export declare namespace ModelTrainingDetails {
    enum AlgorithmHint {
    ...
    function getJsonObj(obj: ModelTrainingDetails): object;
    function getDeserializedJsonObj(obj: ModelTrainingDetails): object;
}
