...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/identity/ChangeDomainLicenseType.ts.html |here} to see how to use ChangeDomainLicenseTypeRequest.
 */
