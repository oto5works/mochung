...
export declare namespace VirtualDeploymentListener {
    enum Protocol {
        Http = "HTTP",
    ...
    function getJsonObj(obj: VirtualDeploymentListener): object;
    function getDeserializedJsonObj(obj: VirtualDeploymentListener): object;
}
