...
export declare namespace IngressGatewayMutualTransportLayerSecurity {
    function getJsonObj(obj: IngressGatewayMutualTransportLayerSecurity): object;
    function getDeserializedJsonObj(obj: IngressGatewayMutualTransportLayerSecurity): object;
}
