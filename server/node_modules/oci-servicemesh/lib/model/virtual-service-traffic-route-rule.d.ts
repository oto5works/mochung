...
export declare namespace VirtualServiceTrafficRouteRule {
    function getJsonObj(obj: VirtualServiceTrafficRouteRule): object;
    function getDeserializedJsonObj(obj: VirtualServiceTrafficRouteRule): object;
}
