...
export declare namespace AccessPolicyTarget {
    function getJsonObj(obj: AccessPolicyTarget): object;
    function getDeserializedJsonObj(obj: AccessPolicyTarget): object;
}
