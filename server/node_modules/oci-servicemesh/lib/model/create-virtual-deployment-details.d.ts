...
export interface CreateVirtualDeploymentDetails {
  ...
  *
      */
    "description"?: string;
    "serviceDiscovery"?: model.DnsServiceDiscoveryConfiguration | model.DisabledServiceDiscoveryConfiguration;
    /**
...
export declare namespace CreateVirtualDeploymentDetails {
    function getJsonObj(obj: CreateVirtualDeploymentDetails): object;
    function getDeserializedJsonObj(obj: CreateVirtualDeploymentDetails): object;
}
