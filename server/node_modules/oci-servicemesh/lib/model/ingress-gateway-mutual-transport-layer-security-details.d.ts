...
export declare namespace IngressGatewayMutualTransportLayerSecurityDetails {
    function getJsonObj(obj: IngressGatewayMutualTransportLayerSecurityDetails): object;
    function getDeserializedJsonObj(obj: IngressGatewayMutualTransportLayerSecurityDetails): object;
}
