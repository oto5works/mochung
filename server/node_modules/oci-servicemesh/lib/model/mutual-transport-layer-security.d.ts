...
export declare namespace MutualTransportLayerSecurity {
    enum Mode {
        Disabled = "DISABLED",
    ...
    function getJsonObj(obj: MutualTransportLayerSecurity): object;
    function getDeserializedJsonObj(obj: MutualTransportLayerSecurity): object;
}
