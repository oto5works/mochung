...
export declare namespace IngressGatewayHostRef {
    function getJsonObj(obj: IngressGatewayHostRef): object;
    function getDeserializedJsonObj(obj: IngressGatewayHostRef): object;
}
