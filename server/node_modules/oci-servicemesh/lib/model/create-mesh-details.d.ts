...
export declare namespace CreateMeshDetails {
    function getJsonObj(obj: CreateMeshDetails): object;
    function getDeserializedJsonObj(obj: CreateMeshDetails): object;
}
