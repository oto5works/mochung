...
export declare namespace VirtualDeployment {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: VirtualDeployment): object;
    function getDeserializedJsonObj(obj: VirtualDeployment): object;
}
