...
export declare namespace IngressGatewayRouteTableSummary {
    function getJsonObj(obj: IngressGatewayRouteTableSummary): object;
    function getDeserializedJsonObj(obj: IngressGatewayRouteTableSummary): object;
}
