...
export declare namespace VirtualServiceRouteTableSummary {
    function getJsonObj(obj: VirtualServiceRouteTableSummary): object;
    function getDeserializedJsonObj(obj: VirtualServiceRouteTableSummary): object;
}
