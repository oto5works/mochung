...
export declare namespace VirtualDeploymentTrafficRuleTarget {
    function getJsonObj(obj: VirtualDeploymentTrafficRuleTarget, isParentJsonObj?: boolean): object;
    const type = "VIRTUAL_DEPLOYMENT";
    function getDeserializedJsonObj(obj: VirtualDeploymentTrafficRuleTarget, isParentJsonObj?: boolean): object;
}
