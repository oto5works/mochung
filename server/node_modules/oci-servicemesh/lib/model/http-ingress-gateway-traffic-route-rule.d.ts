...
export declare namespace HttpIngressGatewayTrafficRouteRule {
    enum PathType {
        Prefix = "PREFIX",
        /**
    ...
    function getJsonObj(obj: HttpIngressGatewayTrafficRouteRule, isParentJsonObj?: boolean): object;
    const type = "HTTP";
    function getDeserializedJsonObj(obj: HttpIngressGatewayTrafficRouteRule, isParentJsonObj?: boolean): object;
}
