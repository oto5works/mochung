...
export declare namespace CreateVirtualServiceRouteTableDetails {
    function getJsonObj(obj: CreateVirtualServiceRouteTableDetails): object;
    function getDeserializedJsonObj(obj: CreateVirtualServiceRouteTableDetails): object;
}
