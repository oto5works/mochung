...
export declare namespace CreateIngressGatewayRouteTableDetails {
    function getJsonObj(obj: CreateIngressGatewayRouteTableDetails): object;
    function getDeserializedJsonObj(obj: CreateIngressGatewayRouteTableDetails): object;
}
