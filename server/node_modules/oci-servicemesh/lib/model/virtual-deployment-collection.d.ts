...
export declare namespace VirtualDeploymentCollection {
    function getJsonObj(obj: VirtualDeploymentCollection): object;
    function getDeserializedJsonObj(obj: VirtualDeploymentCollection): object;
}
