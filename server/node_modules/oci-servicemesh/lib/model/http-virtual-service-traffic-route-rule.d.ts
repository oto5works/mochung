...
export declare namespace HttpVirtualServiceTrafficRouteRule {
    enum PathType {
        Prefix = "PREFIX",
        /**
    ...
    function getJsonObj(obj: HttpVirtualServiceTrafficRouteRule, isParentJsonObj?: boolean): object;
    const type = "HTTP";
    function getDeserializedJsonObj(obj: HttpVirtualServiceTrafficRouteRule, isParentJsonObj?: boolean): object;
}
