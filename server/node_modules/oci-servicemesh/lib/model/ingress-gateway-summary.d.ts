...
export declare namespace IngressGatewaySummary {
    function getJsonObj(obj: IngressGatewaySummary): object;
    function getDeserializedJsonObj(obj: IngressGatewaySummary): object;
}
