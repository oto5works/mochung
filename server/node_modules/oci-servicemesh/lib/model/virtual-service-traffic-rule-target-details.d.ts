...
export declare namespace VirtualServiceTrafficRuleTargetDetails {
    function getJsonObj(obj: VirtualServiceTrafficRuleTargetDetails, isParentJsonObj?: boolean): object;
    const type = "VIRTUAL_SERVICE";
    function getDeserializedJsonObj(obj: VirtualServiceTrafficRuleTargetDetails, isParentJsonObj?: boolean): object;
}
