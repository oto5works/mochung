...
export declare namespace VirtualServiceRouteTable {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: VirtualServiceRouteTable): object;
    function getDeserializedJsonObj(obj: VirtualServiceRouteTable): object;
}
