...
export declare namespace VirtualDeploymentSummary {
    function getJsonObj(obj: VirtualDeploymentSummary): object;
    function getDeserializedJsonObj(obj: VirtualDeploymentSummary): object;
}
