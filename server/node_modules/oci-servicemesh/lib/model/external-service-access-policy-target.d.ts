...
export declare namespace ExternalServiceAccessPolicyTarget {
    enum Protocol {
        Http = "HTTP",
        Https = "HTTPS",
        Tcp = "TCP",
    ...
    function getJsonObj(obj: ExternalServiceAccessPolicyTarget, isParentJsonObj?: boolean): object;
    const type = "EXTERNAL_SERVICE";
    function getDeserializedJsonObj(obj: ExternalServiceAccessPolicyTarget, isParentJsonObj?: boolean): object;
}
