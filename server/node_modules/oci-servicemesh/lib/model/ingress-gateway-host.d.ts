...
export declare namespace IngressGatewayHost {
    function getJsonObj(obj: IngressGatewayHost): object;
    function getDeserializedJsonObj(obj: IngressGatewayHost): object;
}
