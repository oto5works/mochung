 ...
 */
export interface HttpIngressGatewayTrafficRouteRuleDetails extends model.IngressGatewayTrafficRouteRuleDetails {
    /**
     * Route to match
     */
    "path"?: string;
...
export declare namespace HttpIngressGatewayTrafficRouteRuleDetails {
    enum PathType {
        Prefix = "PREFIX"
    }
    function getJsonObj(obj: HttpIngressGatewayTrafficRouteRuleDetails, isParentJsonObj?: boolean): object;
    const type = "HTTP";
    function getDeserializedJsonObj(obj: HttpIngressGatewayTrafficRouteRuleDetails, isParentJsonObj?: boolean): object;
}
