...
(function (CaBundle) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "LOCAL_FILE":
                    return model.LocalFileCaBundle.getJsonObj(jsonObj, true);
                case "OCI_CERTIFICATES":
                    return model.OciCaBundle.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "LOCAL_FILE":
                    return model.LocalFileCaBundle.getDeserializedJsonObj(jsonObj, true);
                case "OCI_CERTIFICATES":
                    return model.OciCaBundle.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
