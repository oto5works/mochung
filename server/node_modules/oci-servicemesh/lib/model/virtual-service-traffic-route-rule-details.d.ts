...
export declare namespace VirtualServiceTrafficRouteRuleDetails {
    function getJsonObj(obj: VirtualServiceTrafficRouteRuleDetails): object;
    function getDeserializedJsonObj(obj: VirtualServiceTrafficRouteRuleDetails): object;
}
