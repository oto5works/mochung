...
export declare namespace TranscriptionTask {
    enum LifecycleState {
        Accepted = "ACCEPTED",
    ...
    function getJsonObj(obj: TranscriptionTask): object;
    function getDeserializedJsonObj(obj: TranscriptionTask): object;
}
