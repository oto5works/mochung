...
export declare namespace TranscriptionNormalization {
    function getJsonObj(obj: TranscriptionNormalization): object;
    function getDeserializedJsonObj(obj: TranscriptionNormalization): object;
}
