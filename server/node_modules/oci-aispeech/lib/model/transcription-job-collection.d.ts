...
export declare namespace TranscriptionJobCollection {
    function getJsonObj(obj: TranscriptionJobCollection): object;
    function getDeserializedJsonObj(obj: TranscriptionJobCollection): object;
}
