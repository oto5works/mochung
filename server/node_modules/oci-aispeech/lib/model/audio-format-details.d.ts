...
export declare namespace AudioFormatDetails {
    function getJsonObj(obj: AudioFormatDetails): object;
    function getDeserializedJsonObj(obj: AudioFormatDetails): object;
}
