...
export declare class ServiceManagerProxyClient {
     ...
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/servicemanagerproxy/GetServiceEnvironment.ts.html |here} to see how to use GetServiceEnvironment API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/servicemanagerproxy/ListServiceEnvironments.ts.html |here} to see how to use ListServiceEnvironments API.
     */
