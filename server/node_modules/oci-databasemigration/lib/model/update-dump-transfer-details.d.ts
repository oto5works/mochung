...
export declare namespace UpdateDumpTransferDetails {
    function getJsonObj(obj: UpdateDumpTransferDetails): object;
    function getDeserializedJsonObj(obj: UpdateDumpTransferDetails): object;
}
