...
export declare namespace CreateDumpTransferDetails {
    function getJsonObj(obj: CreateDumpTransferDetails): object;
    function getDeserializedJsonObj(obj: CreateDumpTransferDetails): object;
}
