...
export declare namespace UpdateAwsS3Details {
    function getJsonObj(obj: UpdateAwsS3Details): object;
    function getDeserializedJsonObj(obj: UpdateAwsS3Details): object;
}
