...
export declare class ResourceSearchClient {
     ...
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/resourcesearch/GetResourceType.ts.html |here} to see how to use GetResourceType API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/resourcesearch/ListResourceTypes.ts.html |here} to see how to use ListResourceTypes API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/resourcesearch/SearchResources.ts.html |here} to see how to use SearchResources API.
     */
