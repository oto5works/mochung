...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/osmanagement/ListModuleStreamsOnManagedInstance.ts.html |here} to see how to use ListModuleStreamsOnManagedInstanceRequest.
 */
...
export declare namespace ListModuleStreamsOnManagedInstanceRequest {
    enum StreamStatus {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        Active = "ACTIVE"
