...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/osmanagement/ListModuleStreamProfilesOnManagedInstance.ts.html |here} to see how to use ListModuleStreamProfilesOnManagedInstanceRequest.
 */
...
export declare namespace ListModuleStreamProfilesOnManagedInstanceRequest {
    enum ProfileStatus {
        Installed = "INSTALLED",
        Available = "AVAILABLE"
    }
