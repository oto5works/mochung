...
export declare namespace ModuleStreamOnManagedInstanceSummary {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: ModuleStreamOnManagedInstanceSummary): object;
    function getDeserializedJsonObj(obj: ModuleStreamOnManagedInstanceSummary): object;
}
