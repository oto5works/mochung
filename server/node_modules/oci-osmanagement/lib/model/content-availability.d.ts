 ...
 *
 **/
export declare enum ContentAvailability {
...
export declare namespace ContentAvailability {
    function getJsonObj(obj: ContentAvailability): ContentAvailability;
    function getDeserializedJsonObj(obj: ContentAvailability): ContentAvailability;
}
