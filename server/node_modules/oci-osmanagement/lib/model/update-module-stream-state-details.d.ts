...
export declare namespace UpdateModuleStreamStateDetails {
    function getJsonObj(obj: UpdateModuleStreamStateDetails): object;
    function getDeserializedJsonObj(obj: UpdateModuleStreamStateDetails): object;
}
