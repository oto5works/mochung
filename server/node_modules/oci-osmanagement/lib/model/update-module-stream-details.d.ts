...
export declare namespace UpdateModuleStreamDetails {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        Active = "ACTIVE"
    }
    function getJsonObj(obj: UpdateModuleStreamDetails): object;
    function getDeserializedJsonObj(obj: UpdateModuleStreamDetails): object;
}
