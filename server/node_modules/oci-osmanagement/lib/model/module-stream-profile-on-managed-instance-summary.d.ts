...
export declare namespace ModuleStreamProfileOnManagedInstanceSummary {
    enum Status {
        Installed = "INSTALLED",
        Available = "AVAILABLE",
        /**
    ...
    function getJsonObj(obj: ModuleStreamProfileOnManagedInstanceSummary): object;
    function getDeserializedJsonObj(obj: ModuleStreamProfileOnManagedInstanceSummary): object;
}
