...
export declare namespace UpdateModuleStreamProfileDetails {
    enum Status {
        Installed = "INSTALLED",
        Available = "AVAILABLE"
    }
    function getJsonObj(obj: UpdateModuleStreamProfileDetails): object;
    function getDeserializedJsonObj(obj: UpdateModuleStreamProfileDetails): object;
}
