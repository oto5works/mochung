...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.62.0/datasafe/ListOnPremConnectors.ts.html |here} to see how to use ListOnPremConnectorsRequest.
 */
