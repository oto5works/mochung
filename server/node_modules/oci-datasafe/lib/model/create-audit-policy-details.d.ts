...
export declare namespace CreateAuditPolicyDetails {
    function getJsonObj(obj: CreateAuditPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateAuditPolicyDetails): object;
}
