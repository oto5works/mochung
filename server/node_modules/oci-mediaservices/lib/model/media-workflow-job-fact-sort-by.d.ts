 ...
 **/
export declare enum MediaWorkflowJobFactSortBy {
    Key = "key"
}
export declare namespace MediaWorkflowJobFactSortBy {
    function getJsonObj(obj: MediaWorkflowJobFactSortBy): MediaWorkflowJobFactSortBy;
    function getDeserializedJsonObj(obj: MediaWorkflowJobFactSortBy): MediaWorkflowJobFactSortBy;
}
