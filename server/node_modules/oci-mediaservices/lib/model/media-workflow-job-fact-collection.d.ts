...
export declare namespace MediaWorkflowJobFactCollection {
    function getJsonObj(obj: MediaWorkflowJobFactCollection): object;
    function getDeserializedJsonObj(obj: MediaWorkflowJobFactCollection): object;
}
