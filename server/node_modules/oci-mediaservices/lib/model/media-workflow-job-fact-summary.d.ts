...
export declare namespace MediaWorkflowJobFactSummary {
    function getJsonObj(obj: MediaWorkflowJobFactSummary): object;
    function getDeserializedJsonObj(obj: MediaWorkflowJobFactSummary): object;
}
