...
var resolveEl = (target) => {
  ...
  return (_a = target.$el) != null ? _a : target;
};
...
var DateRange = class {
  constructor(config, locale = new Locale()) {
    ...
    this.order = order2 != null ? order2 : 0;
    if (repeat) {
  ...
  static from(source, locale) {
    ...
    if (source != null) {
      if (isArray(source)) {
        config.start = (_a = source[0]) != null ? _a : null;
        config.end = (_b = source[1]) != null ? _b : null;
  ...
  intersectsRange(range) {
    ...
    return this.intersectsDayRange(
      (_a2 = (_a = range.start) == null ? void 0 : _a.dayIndex) != null ? _a2 : -Infinity,
      (_b2 = (_b = range.end) == null ? void 0 : _b.dayIndex) != null ? _b2 : Infinity
    );
  }
...
var DateRangeContext = class {
  ...
  render(data2, range, days) {
    ...
    if (range.hasRepeat) {
      days.forEach((day) => {
        ...
        if (range.startsOnDay(day)) {
          ...
          result = {
            ...
            startTime: (_a3 = (_a22 = range.start) == null ? void 0 : _a22.time) != null ? _a3 : 0,
            endDay: day.dayIndex + span - 1,
            endTime: (_b3 = (_b22 = range.end) == null ? void 0 : _b22.time) != null ? _b3 : MS_PER_DAY
          };
      ...
      result = {
        startDay: (_a2 = (_a = range.start) == null ? void 0 : _a.dayIndex) != null ? _a2 : -Infinity,
        startTime: (_b2 = (_b = range.start) == null ? void 0 : _b.time) != null ? _b2 : -Infinity,
        endDay: (_c2 = (_c = range.end) == null ? void 0 : _c.dayIndex) != null ? _c2 : Infinity,
        endTime: (_d2 = (_d = range.end) == null ? void 0 : _d.time) != null ? _d2 : Infinity
      };
      this.getRangeRecords(data2).push(result);
    }
    return result;
...
var Attribute = class {
  constructor(config, theme, locale) {
    ...
    this.ranges = locale.ranges(dates != null ? dates : []);
...
function createBase(props) {
  const color = computed(() => {
    var _a;
    return (_a = props.color) != null ? _a : "";
  });
  const isDark = computed(() => {
    var _a;
    return (_a = props.isDark) != null ? _a : false;
  });
  ...
  const disabledDates = computed(() => {
    var _a;
    const dates = (_a = props.disabledDates) != null ? _a : [];
...
function createCalendar(props, { emit, slots }) {
  ...
  const firstPage = computed(() => {
    var _a;
    return (_a = head_1(_pages.value)) != null ? _a : null;
  });
  const lastPage = computed(() => {
    var _a;
    return (_a = last_1(_pages.value)) != null ? _a : null;
  });
  ...
  const targetBy = (pages) => {
    var _a;
    const fromPage = (_a = firstPage.value) != null ? _a : getDateAddress(new Date());
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(show).prev ? (openBlock(), createElementBlock("button", {
          ...
          onClick: _cache[0] || (_cache[0] = (...args) => unref(movePrev) && unref(movePrev)(...args)),
        ...
        unref(show).next ? (openBlock(), createElementBlock("button", {
          ...
          onClick: _cache[2] || (_cache[2] = (...args) => unref(moveNext) && unref(moveNext)(...args)),
...
var _sfc_main$8 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    async function show(opts = {}) {
      ...
      if (opts.force)
        state2.force = true;
      setTimer((_a = opts.showDelay) != null ? _a : props.showDelay, () => {
        if (state2.isVisible) {
          state2.force = false;
          emit("after-show");
        }
    ...
    function hide2(opts = {}) {
      ...
      if (opts.force)
        state2.force = true;
      setTimer((_a = opts.hideDelay) != null ? _a : props.hideDelay, () => {
        if (!state2.isVisible)
          state2.force = false;
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$5, [
          ...
          createBaseVNode("button", {
            ...
            onClick: _cache[2] || (_cache[2] = (...args) => unref(toggleMode) && unref(toggleMode)(...args)),
          ...
          createBaseVNode("button", {
            ...
            onClick: _cache[4] || (_cache[4] = (...args) => unref(moveNext) && unref(moveNext)(...args)),
...
function createDatePicker(props, ctx) {
  ...
  const dateParts = computed(
    () => {
      var _a;
      return getDateParts2((_a = dragValue.value) != null ? _a : dateValue.value);
    }
  );
  ...
  const popover = computed(() => {
    var _a2;
    var _a;
    const target = (_a2 = (_a = popoverRef.value) == null ? void 0 : _a.$el.previousElementSibling) != null ? _a2 : void 0;
  ...
  const rules = computed(() => {
    ...
    return normalizeConfig2(
      props.rules === "auto" ? getAutoRules() : (_a = props.rules) != null ? _a : {}
    );
  });
  ...
  function normalizeValue(value, config2, patch, targetPriority) {
    ...
    if (isRange.value) {
      const start2 = locale.value.toDate(value.start, {
        ...config2[0],
        fillDate: (_a = valueStart.value) != null ? _a : void 0,
        patch
      });
      const end2 = locale.value.toDate(value.end, {
        ...config2[1],
        fillDate: (_b = valueEnd.value) != null ? _b : void 0,
        patch
      });
  ...
  function forceUpdateValue(value, {
    ...
    if (isDisabled) {
      ...
      normalizedValue = dateValue.value;
    } else if (normalizedValue != null && valuesAreEqual(dateValue.value, normalizedValue) && clearIfEqual) {
    ...
    if (fInput)
      formatInput();
    if (mValue) {
      nextTick(() => moveToValue(targetPriority != null ? targetPriority : "start"));
    }
