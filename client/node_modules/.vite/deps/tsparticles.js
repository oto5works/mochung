  ...
  constructor(absorbers, container, options, position) {
    ...
    this._updateParticlePosition = (particle, v) => {
      ...
      if (this.options.orbits) {
        ...
        particle.absorberOrbit.angle += ((_a2 = particle.retina.moveSpeed) != null ? _a2 : 0) * container2.retina.pixelRatio / 100 * container2.retina.reduceFactor;
      } else {
    ...
    this.color = (_a = rangeColorToRgb(this.options.color)) != null ? _a : {
      b: 0,
      g: 0,
      r: 0
    };
...
var Absorbers = class {
  ...
  handleClickMode(mode) {
    ...
    if (mode === "absorber") {
      const absorbersModeOptions = itemFromSingleOrMultiple(modeAbsorbers), absorbersOptions = absorbersModeOptions != null ? absorbersModeOptions : itemFromSingleOrMultiple(absorberOptions), aPosition = this.container.interactivity.mouse.clickPosition;
...
function addSplitParticle(engine, container, parent, splitParticlesOptions) {
  ...
  if (splitOptions.color) {
    ...
    options.color.load({
      value: {
        hsl: {
          h: parentColor.h + getRangeValue((_a = splitOptions.colorOffset.h) != null ? _a : 0),
          s: parentColor.s + getRangeValue((_b = splitOptions.colorOffset.s) != null ? _b : 0),
          l: parentColor.l + getRangeValue((_c = splitOptions.colorOffset.l) != null ? _c : 0)
        }
      }
    });
  } else {
  ...
  return container.particles.addParticle(position, options, parent.group, (particle) => {
    ...
    particle.splitCount = ((_a2 = parent.splitCount) != null ? _a2 : 0) + 1;
...
var EmitterInstance = class {
  constructor(engine, emitters, container, options, position) {
    ...
    this._emitParticles = (quantity) => {
      ...
      for (let i = 0; i < quantity; i++) {
        ...
        const pPosition = (_c2 = (_b2 = this._shape) == null ? void 0 : _b2.randomPosition(position2, size, this.fill)) != null ? _c2 : position2;
    ...
    this._setColorAnimation = (animation, initValue, maxValue) => {
      ...
      const colorOffset = randomInRange(animation.offset), delay = getRangeValue(this.options.rate.delay), emitFactor = 1e3 * delay / container2.retina.reduceFactor, colorSpeed = getRangeValue((_a2 = animation.speed) != null ? _a2 : 0);
    ...
    this._spawnDelay = ((_a = this.options.life.delay) != null ? _a : 0) * 1e3 / this.container.retina.reduceFactor;
    this.position = (_b = this._initialPosition) != null ? _b : this._calcPosition();
    this.name = this.options.name;
    this._shape = (_c = this._engine.emitterShapeManager) == null ? void 0 : _c.getShape(this.options.shape);
    ...
    (_d = particlesOptions.move) != null ? _d : particlesOptions.move = {};
    (_f = (_e = particlesOptions.move).direction) != null ? _f : _e.direction = this.options.direction;
    if (this.options.spawnColor) {
      this.spawnColor = rangeColorToHsl(this.options.spawnColor);
    }
    this._paused = !this.options.autoPlay;
    this._particlesOptions = particlesOptions;
    this.size = (_g = this.options.size) != null ? _g : (() => {
    ...
    this._lifeCount = (_h = this.options.life.count) != null ? _h : -1;
  ...
  play() {
    ...
    if (!(this.container.retina.reduceFactor && (this._lifeCount > 0 || this._immortal || !this.options.life.count) && (this._firstSpawn || this._currentSpawnDelay >= ((_a = this._spawnDelay) != null ? _a : 0)))) {
      return;
    }
  ...
  update(delta) {
    ...
    if (this._firstSpawn) {
      ...
      this._currentSpawnDelay = (_a = this._spawnDelay) != null ? _a : 0;
      this._currentEmitDelay = (_b = this._emitDelay) != null ? _b : 0;
    }
    ...
    if (this._duration !== void 0) {
      ...
      if (this._currentDuration >= this._duration) {
        ...
        if (this._lifeCount > 0 || this._immortal) {
          ...
          this._spawnDelay = ((_c = this.options.life.delay) != null ? _c : 0) * 1e3 / this.container.retina.reduceFactor;
        } else {
          this._destroy();
        }
      ...
      if (interactivityEmitters instanceof Array) {
        ...
        if (emitterMode.value !== void 0) {
          if (emitterMode.value instanceof Array) {
            options.interactivity.modes.emitters = {
              random: {
                count: (_c = emitterMode.random.count) != null ? _c : 1,
            ...
            options.interactivity.modes.emitters = {
              random: {
                count: (_e = emitterMode.random.count) != null ? _e : 1,
...
function updateTilt(particle, delta) {
  ...
  const tilt = particle.options.tilt, tiltAnimation = tilt.animation, speed = ((_a = particle.tilt.velocity) != null ? _a : 0) * delta.factor, max = 2 * Math.PI, decay = (_b = particle.tilt.decay) != null ? _b : 1;
...
function updateWobble(particle, delta) {
  ...
  const angleSpeed = wobble.angleSpeed * delta.factor, moveSpeed = wobble.moveSpeed * delta.factor, distance = moveSpeed * (((_a = particle.retina.wobbleDistance) != null ? _a : 0) * delta.factor) / (1e3 / 60), max = 2 * Math.PI, { position } = particle;
...
var WobbleUpdater = class {
  ...
  init(particle) {
    ...
    particle.retina.wobbleDistance = getRangeValue((_a = wobbleOpt == null ? void 0 : wobbleOpt.distance) != null ? _a : 0) * this.container.retina.pixelRatio;
  }
  isEnabled(particle) {
    var _a;
