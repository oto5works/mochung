...
<div class="pa_vw--0">
  ...
  <div class="display_flex--block">
      ...
      <Main_audio class="width_50--100" :main="main" :audio_url="audio_url" />
  </div>
</div>
...
<div id="wedding" class="write__content pa_vw--0">
  ...
  <div class="display_flex--block">
    ...
    <Wedding_map class="width_50--100" v-model:map_id="map_id" :wedding="wedding" />
  </div>
  <Wedding_app :wedding="wedding" />

  <div class="display_flex--block">
    <Wedding_transport class="width_50--100" :wedding="wedding" :input="custom.style_input" />
    <Wedding_guide class="width_50--100" :wedding="wedding" :input="custom.style_input" />
  </div>
</div>
<div class="sp_120"/>
...
export default {
  components: { Preview, 
    Preview_button, Write_title, v_navigation, v_appbar, v_overlay,
  ...
  return {
    ...
    title: {
      ...
      wedding: {
        ...
        guide_title: '예식 안내',
        guide_content: '<h1><strong>본식</strong></h1><p>12시 0분 (접수 11시 30분)</p><p>&nbsp;</p><h1><strong>피로연</strong></h1><p>13시 0분 (접수 12시 30분)</p><p>&nbsp;</p><h2><u><strong>피로연 장소는 본관 5층 입니다.</strong></u></h2>',
      },
info: {
  image: 'true',
