<template>
  <div class="svgColor thumb-svg">
    ...
    >
      <g>
        <rect y="0" class="background" width="256" height="256" />
        <path
          class="hair"
          d="M187.4,127.6c4.9-6.6,6.9-17.6,3.4-25.4c-8.6-12.3-26.3-21.1-40.4-12.1c-10.9,8.1-17.9,20-23.3,32.2
        ...
        <path
          class="background"
          d="M112.1,103.5c-7.1,17.8-32.1,3.5-23.6-7C68.2,87.2,88.1,61,98.6,80c-1.7-4,2-8.8,6.3-9.5
				c8.7-1.7,19.9,11.1,12.2,18.3c4.9,0.3,15.2,4.3,10.5,10.4C124.9,105.2,117.2,109.1,112.1,103.5z"
        />
        <path
          class="clothes"
          d="M106.8,93.5c1.4-7.5-11.1-8.1-6.8,0.1C101.6,96,105.8,96.9,106.8,93.5z"
        />
        <path
          class="clothes"
          d="M65.6,186.4c-10.8,8.7-26,2.9-38.6,7.5c-1.9,17.3-3.4,35.2,0.7,52.1c6.1-0.5,13.8,2,19.8,3.4v6.5l132.5-0.2
        ...
        <path
          class="skin"
          d="M0.2,204.3c8.5-1.2,17.2,0.4,25.7,0.6c-1,11.2-1.3,22.5,0.3,33.5c-8.2-3.4-17.6-3.6-26.2-1L0.2,204.3z"
        />
        <path
          class="skin"
          d="M115,191.3c9.1,9.2,20.8,21.5,28.2,29.8c1.9-10.4,8.3-19.1,14.5-27.4c3.8-3.1,9.7-2.6,13.7-5.7
        ...
        <path
          class="line"
          d="M145.4,223.3c3.3,3.5,6.5,7.1,9.5,10.9
