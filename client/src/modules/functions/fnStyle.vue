...
import { setColorStyle, setDocumentAttribut, setDocumentProperty } from '@/services/function';
export default {
  computed: {
    ...mapGetters({
  ...
  watch: {
    ...
    'customData.backgroundColor': (newValue) => setColorStyle('background', newValue),
    // align
    ...
    'customData.fontSize': (newValue) => setDocumentAttribut('font-size', newValue),
    'customData.fontWeight': (newValue) => setDocumentAttribut('font-weight', newValue),

    'customData.fontColor': (newValue) => setDocumentProperty('font-color', newValue),
    homeColor: (newValue) => setDocumentProperty('home-color', newValue),    
    'customData.gradient1': (newValue) => setDocumentProperty('gradient-1', newValue),
    'customData.gradient2': (newValue) => setDocumentProperty('gradient-2', newValue),
    'customData.gradient3': (newValue) => setDocumentProperty('gradient-3', newValue),
