...
import audios from "@/components/icon/audios";
  ...
  computed: {
    ...
    videoPreview() {
      if (this.audiosData.url) {
        ...
        const youtubeMatch = this.audiosData.url.match(
