  ...
  <v-bottom-sheet v-model="sheet">
    <template v-slot:activator="{ props }">
      <div class="flex flex-direction_column --align-items">
        <button class="button-defaulted height_40 gap_8 pa_24 --border-radius_32" v-bind="props">
          <icon><location /></icon>
          <span>앱으로 확인하기</span>
        </button>
      </div>
...
<div class="flex align-items_center justify-content_space-between pa_16 height_40">
<h5>연결가능한 앱목록</h5><button @click="sheet = false"><icon><x /></icon></button>
</div>

<div class="primary__hover position_relative display_flex align-items_center width_100 height_48 pa_16 cursor_pointer" @click="handleNaverMap">
  <div class="flex align-items_center gap_16">
    <button class="navermap width_38 height_38 border-radius_12"><icon icon="appNavermap"><appNavermap /></icon></button>
    <h4>네이버맵</h4>
  </div>
</div>

<div class="primary__hover position_relative display_flex align-items_center width_100 height_48 pa_16 cursor_pointer" @click="handleKakaoMap">
  <div class="flex align-items_center gap_16">
    <button class="kakao width_38 height_38 border-radius_12"><icon icon="appKakaomap"><appKakaomap /></icon></button>
    <h4>카카오맵</h4>
  </div>
</div>

<div class="primary__hover position_relative display_flex align-items_center width_100 height_48 pa_16 cursor_pointer" @click="handleKakaoNavi">
  <div class="flex align-items_center gap_16">
    <button class="kakao width_38 height_38 border-radius_12"><icon icon="appKakaonavi"><appKakaonavi /></icon></button>
    <h4>카카오네비</h4>
  </div>
</div>

<div class="primary__hover position_relative display_flex align-items_center width_100 height_48 pa_16 cursor_pointer" @click="handleTmap">
  <div class="flex align-items_center gap_16">
    <button class="tmap width_38 height_38 border-radius_12"><icon icon="appTmap"><appTmap /></icon></button>
    <h4>티맵</h4>
  </div>
</div>
